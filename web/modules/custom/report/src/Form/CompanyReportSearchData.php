...
class CompanyReportSearchData extends FormBase {
  /**
   * {@inheritdoc}
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if($start_date!='' && $start_date!=''){
      ...
      '#type' => 'markup',
      '#weight' => 1999,
      '#prefix' => '<div id="export-data"><a href="/company-report-download?start_date='.$start_date.'&end_date='.$last_date.'">Export Data <i class="fas fa-download"></i></a></div>',
    ];
