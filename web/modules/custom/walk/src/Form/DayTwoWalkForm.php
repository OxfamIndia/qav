...
*/
  ...
  public function submitForm(array &$form, FormStateInterface $form_state){
    ...
    $event_name = $event_data->getTitle();
     ...
     $last_pending_walk= $walker_total_distance-$walker_day1_dist;
     $pending_walk =$walker_total_distance-$distanace-$walker_day1_dist;
     $actual_pending_walk =$walker_total_distance-$distanace-$walker_day1_dist;
     $current_walk_distance= $distanace+$walker_day1_dist;
      if($pending_walk < 0){
       $pending_walk = 0;
     }
