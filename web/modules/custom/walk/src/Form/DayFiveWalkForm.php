...
class DayFiveWalkForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state){
    ...
    foreach ($nids as $nid) {
      ...
      $report_total_walk = $walker_day1_dist+$distanace+$walker_day3_dist+$walker_day4_dist+$walker_day2_dist+$walker_day6_dist+$walker_day7_dist+$walker_day8_dist+$walker_day9_dist+$walker_day10_dist;
